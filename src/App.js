  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text) => (
        <div
        style={{
          backgroundColor: text === "1000/1000" ? "red" : "inherit",
          color: text === "1000/1000" ? "white" : "inherit", // Cambiar el color del texto si es necesario
          padding: "4px", // Añadir un poco de padding para que se vea mejor
    ...
    <div style={{padding:"100px"}}>
      ...
      {loading ? (
        ...
        <Table
          ...
          size="small"
          pagination={{
            pageSize: 15000, // Número de filas por página
           ...
           // Si la tabla es demasiado grande, se puede ajustar para mostrar el scroll
        />
      )}
    </div>
  </ConfigProvider>
